...
class DirectFetcher:
    ...
    def job(self,args):
        ...
        try:
            with open("commands.txt", "r") as data_file:
        ...
        try:
            ...
            for i in xrange(len(commandSettings["commandList"])):
                ...
                if (commandCheck.split(" ",1)[0]=="show" or commandCheck =="request support information"):
                    ...
                    output["host_%s"%args["host"]] += commandOutput
